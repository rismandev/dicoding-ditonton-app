...
void main() {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('features/movie/dummy_data/now_playing.json'), 200));
      // act
  ...
  group('get Popular Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('features/movie/dummy_data/popular.json')))
        .movieList;
    ...
    test('should return list of movies when response is success (200)',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('features/movie/dummy_data/popular.json'), 200));
      // act
  ...
  group('get Top Rated Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('features/movie/dummy_data/top_rated.json')))
        .movieList;
    ...
    test('should return list of movies when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('features/movie/dummy_data/top_rated.json'), 200));
      // act
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailResponse.fromJson(
        json.decode(readJson('features/movie/dummy_data/movie_detail.json')));

    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('features/movie/dummy_data/movie_detail.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(json.decode(
            readJson('features/movie/dummy_data/movie_recommendations.json')))
        .movieList;
    final tId = 1;
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(json.decode(
            readJson('features/movie/dummy_data/search_spiderman_movie.json')))
        .movieList;
